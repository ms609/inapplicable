...
devtools::install_github('KlausVigo/phangorn', ref='7192bfb4403c35c16a7b735160525d272736b061', INSTALL_opts='--byte-compile') # 30 Oct 2017
```
...
It's also worth installing a compiled version of `ape` for additional speed:

```r
install.packages('ape', INSTALL_opts='--byte-compile')
```
