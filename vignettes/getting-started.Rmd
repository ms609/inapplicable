...
With the Asher 2005 dataset, three marsupial taxa are used as an outgroup.  
...
outgroup.branch <- ape::rtree(length(outgroup), tip.label=outgroup, br=NULL)
ingroup.branch <- ape::drop.tip(nj.tree, outgroup)
rooted.tree <- ape::root(ape::bind.tree(outgroup.branch, ingroup.branch, 0, 1), outgroup, resolve.root=TRUE)
```
