...
#'
#' @format \describe{
#' \item{\code{inapplicable.datasets}}{An object of class list of length 30.  The name of each item corresponds to the 
#' datasets listed below.  Datasets are sorted into two subsets, each sorted alphabetically;
#' the first subset comprise simpler datasets with faster processing times.  The value is the
#' dataset in the format generated by \code{\link{read.nexus.data}}.}
#' \item{\code{inapplicable.datasets}}{An object of class list of length 30.  The name of each item corresponds to the 
#' datasets listed below.  The value is a representation of the dataset in \code{phyDat} format.}
#' \item{\code{inapplicable.datasets}}{A vector of length 30.  The name of each item corresponds to the 
#' datasets listed below.  The value gives their citation.}
#' }
#'
#' @source {
#'  \describe{
...
#' }
#'
#' @references BRAZEAU, M. D., GUILLERME, T. and SMITH, M. R. 2017. Morphological phylogenetic analysis with inapplicable data. BioRxiv.
#'
#' @keywords datasets
"inapplicable.datasets"
"inapplicable.phyData"
